<template>
    <div class="content-page">
        ...
        <div class="content-main">
            <div style="text-align:center;" class="form-table-box">
                <p v-html="infoForm.article_header" aria-placeholder="这里应该是标题"></p>
                <p v-html="infoForm.username" aria-placeholder="这是作者"></p>
                <p v-html="infoForm.article_post_time" aria-placeholder="这是发布时间"></p>
                <p v-html="infoForm.article_contract" aria-placeholder="这里是摘要"></p>
                <div v-html="infoForm.article_content" aria-placeholder="这是正文"></div>
            </div>
            <!-- <div class="form-table-box">

                <el-form ref="infoForm" :rules="infoRules" :model="infoForm" label-width="120px">
                    <el-form-item label="文章名称" prop="name">
                        <el-input v-model="infoForm.article_header"></el-input>
                    </el-form-item>
                    ...
                    <el-form-item label="广告图片" prop="image_url">
                        <el-upload class="image-uploader" name="ad_pic"
                                   action="http://127.0.0.1:8360/admin/upload/article_adPic" :show-file-list="false"
        ...
        methods: {
            ...
            onSubmitInfo() {
                this.$refs['infoForm'].validate((valid) => {
                    if (valid) {
                        this.axios.post('article_advert/store', this.infoForm).then((response) => {
            ...
            getInfo() {
                ...
                //加载品牌详情
                let that = this
                this.axios.get('article/ArticleInfo', {
                    params: {
                        article_id: that.infoForm.id
                    }
                }).then((response) => {
                    let resInfo = response.data.data;
                    window.console.log(resInfo);
                    ...
                    resInfo.on_top = resInfo.on_top ? true : false;
