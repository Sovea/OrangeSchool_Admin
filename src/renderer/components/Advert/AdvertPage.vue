	...
	<div class="content-page">
		<div class="content-nav">
			...
			<div class="operation-nav">
				<router-link to="/dashboard/advert/add">
...
export default {
	...
	methods: {
		...
		handleRowEdit(index, row) {
			this.$router.push({ name: 'advert_add', query: { id: row.id } })
		},
		handleRowDelete(index, row) {
			...
			this.$confirm('确定要删除?', '提示', {
				...
				this.axios.post('advert/destory', { id: row.id }).then((response) => {
